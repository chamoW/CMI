 ...
 */
@Entity
@Table(name = "cargo", catalog = "tris_cmi", schema = "cmi")
@NamedQueries({
    ...
    @NamedQuery(name = "Cargo.findByDepartamento", query = "SELECT c FROM Cargo c WHERE c.departamento.id = :id"),    
    @NamedQuery(name = "Cargo.findByOrden", query = "SELECT c FROM Cargo c WHERE c.orden = :orden")})
public class Cargo implements Serializable {
    ...
    public String toString() {
        return "com.triskel.cmi.dal.model.Cargo[ id=" + id + " ]";
    }
